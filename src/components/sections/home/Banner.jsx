    ...
    >
      ...
      <div>
        <p className="font-bold text-alternative md:text-[1.8rem] sm:text-[1.3rem] text-[1.1rem]">
          ...
          {isMobile ? 'OPCIONES PARA COMPRAR' : (
            <>
              OPCIONES
              <br />
              PARA COMPRAR
      ...
      <div className="flex items-center justify-around grow-[0.3] md:gap-14 sm:gap-8 gap-3">
        <div>
          <a href="https://www.instagram.com/custombouti/" className="banner_iconContainer" target="_blank" rel="noreferrer">
        ...
        <div className={isTablet ? 'hidden' : 'banner_separator'} />

        <div>
          <a href="https://custom15.mitiendanube.com/productos/" className="banner_iconContainer" target="_blank" rel="noreferrer">
            <img src={isMobile ? mobileWp : wp} alt="icono tienda nube" className="banner_icon" />
            <p className="text-alternative text-center md:text-xl sm:text-lg">
              {isTablet ? 'Tienda Nube' : (
                <>
                  Visitá nuestra
                  <br />
                  Tienda Nube
        ...
        <div>
          <a
            href="https://api.whatsapp.com/send/?phone=5492915661652&text=Hola%21+Estoy+interesada+en+las+prendas+que+tienes+publicadas&type=phone_number&app_absent=0"
            className="banner_iconContainer"
            target="_blank"
            rel="noreferrer"
          >
