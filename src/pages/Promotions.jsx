...
const Promotions = () => {
  ...
  return (
    <section id="promotions" className="pt-[36px] md:pt-[60px] xl:pt-[80px] m-auto max-w-[1440px] px-[27px] md:px-[81px] pb-[40px] md:pb-[65px] xl:pb-20 flex flex-col items-center">
